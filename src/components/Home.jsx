  ...
  return (
    <div className='flex justify-around items-center p-10 space-x-10 lg:flex-row ssm:flex-col ssm:space-y-10 text-white' id='home'>
        <div className='lf:w-1/2 ssm:w-fit'>
            <img src={me} alt="" className="rounded-full w-60 h-50  border-8 border-white" />

            <p className='text-4xl mx-8 mb-5'> Hi, I'm</p>
            <h3 className='text-4xl mx-8'>Faith Obetta</h3>
            <hr />
